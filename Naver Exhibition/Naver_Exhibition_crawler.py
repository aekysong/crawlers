...
#     print(data_list)
    ...
    try:
        ...
        temp_x = data_list['result']['place']['list'][0]['x']
        temp_y = data_list['result']['place']['list'][0]['y']
...
with open('exhibition.json', 'w', encoding='utf-8') as f:
...
with open('exhibition_address.json', 'w', encoding='utf-8') as f:
